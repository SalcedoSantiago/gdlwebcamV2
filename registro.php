...
<section class="contenedor separate">
    <h2>Registro de usuarios</h2>
    <div class="img-programa">
        <img src="/img/separador.png" alt="">
    </div>
    <form class="registro" id="registro" method="POST" action="pagar.php">
                ...
                <ul class="contenedor-precios">
                    <li class="borderbox">
                        <div class="contenido-precios">
                            ...
                            <label for="pase_dia">Pase por dia</label>
                    ...
                    <li class="borderbox">
                        <div class="contenido-precios">
                            ...
                            <label for="todos_dias">Todos los dias</label>
                            <input type="number" id="todos_dias" name="boletos[completo][cantidad]" min="0" size="3" placeholder="0">
                    ...
                    <li class="borderbox">
                        <div class="contenido-precios">
                            ...
                            <label for="paso_dosdias">Pase dos dias</label>
                            <input type="number" id="pase_dosdias" name="boletos[2dias][cantidad]" min="0" size="3" placeholder="0">
        ...
        <div class="resumen" id="resumen">
            ...
            <div class="cajax caja clearfix">
                <div class="extras">
                    <div class="orden">
                        <label for="camisas">Camisas del evento $10 (promocion 7% dto.)</label>
                        <input type="number" id="camisa" name="pedido_extra[camisas][cantidad]" placeholder="camisas">
                        <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                    </div>
                    <div class="orden">
                        <label for="paquetes">Paquetes de 10 Etiquetas $2(HTML5, CSS3, JavaScript, Chrome, Google)</label>
                        <input type="number" id="paquete" name="pedido_extra[paquetes][cantidad]" placeholder="paquetes">
                        <input type="hidden" value="2" name="pedido_extra[paquetes][precio]">
                    </div>
                    <div class="orden">
                        <select name="regalo" id="regalo">Selecciona un regalo
                ...
                <div class="total">
                    ...
                    <input type="submit" id="btnRegistro" name="submit" class="btn">
                </div>
            </div>
        </div>
